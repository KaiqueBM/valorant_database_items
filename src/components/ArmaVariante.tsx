          ...
          {index !== 0 && (
            <div className="xl:mx-2 mx-10 xl:mb-0 mb-8">
              ...
              <div className="text-center">
                <img
                  className="rounded-lg inline-block h-6 mx-1"
                  src={chromas.swatch}
                />
                <span className="text-center text-black font-raj text-xl font-semibold">
                  {formatarTextoVariante(chromas.displayName)}
                </span>
              </div>
              <video
