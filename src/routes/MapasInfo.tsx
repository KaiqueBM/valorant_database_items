				...
				<>
					...
					<div className="grid lg:grid-cols-2 items-center">
						<div className="mx-auto p-10">
							<p className='md:text-2xl text-xl text-center lg:py-2 px-10 text-vava font-fira uppercase'>Minimapa</p>
						...
						<div className="md:text-2xl text-xl text-center lg:py-10 px-10 text-vava font-fira">
							<p className='md:text-2xl text-xl text-center lg:py-2 px-10 text-vava font-fira uppercase'>Icone do mapa</p>
							<img className="mx-auto rounded-lg w-full mb-5" src={mapaAtual.listViewIcon} />
							<p className='md:text-2xl text-xl text-center lg:py-2 px-10 text-vava font-fira uppercase'>Imagem do mapa</p>
